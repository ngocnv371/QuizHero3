...
Manually deploy this infrastructure with Terraform.

Then deploy the app with Visual Studio publish profile - ZipDeploy.

Worked, but still missing stuff in libs folder.

Must try Docker next.